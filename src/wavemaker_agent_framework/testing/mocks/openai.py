...
def create_mock_openai_client(response_content: Optional[str] = None) -> MagicMock:
    ...
    Usage:
        ```python
        from wavemaker_agent_framework.testing.mocks import create_mock_openai_client
...
def create_mock_openai_error(error_type: str = "rate_limit") -> MagicMock:
    ...
    Usage:
        ```python
        from wavemaker_agent_framework.testing.mocks import create_mock_openai_error
        import pytest
...
def mock_json_response(json_content: Dict[str, Any], format_type: str = "plain") -> str:
    ...
    Usage:
        ```python
        from wavemaker_agent_framework.testing.mocks import mock_json_response
