...
Usage in agent tests:
    ...
    from bigripple_agent_framework.testing.fixtures import *
...
def mock_env_vars(monkeypatch):
    ...
    Usage:
        ...
        def test_config_loading(mock_env_vars):
            from bigripple_agent_framework.core import AgentConfig
    ...
    Agents can extend this fixture with additional environment variables:
        ...
        def mock_env_vars(monkeypatch):
            ...
            from bigripple_agent_framework.testing.fixtures import mock_env_vars as base_mock
