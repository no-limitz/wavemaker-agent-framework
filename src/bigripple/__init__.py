...
Quick Start:
    ```python
    from bigripple import BigRippleAgent, EntityContext
...
# Operations
from bigripple.operations import (
    OperationExtractor,
    ResponseFormatter,
    EntityOperationType,
)
